...
builder.Services.AddScoped<ITheBestWeekTopStatsService, TheBestWeekTopStatsService>();
...
builder.Services.Configure<SeasonRolloverNotificationOptions>(
    configuration.GetSection("SeasonRolloverNotifications"));
builder.Services.AddSingleton<ISeasonRolloverNotificationStore, RedisSeasonRolloverNotificationStore>();
builder.Services.AddScoped<ISeasonRolloverNotifier, SeasonRolloverNotifier>();
