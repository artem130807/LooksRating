...
namespace LooksRatingApi.Migrations
{
    ...
    [Migration("20260521141030_MoveUserFeedSettingsToRecomendationSettings")]
    partial class MoveUserFeedSettingsToRecomendationSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoUserTheBestWeek", b =>
                {
                    b.Property<Guid>("PhotoUsersId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TheBestWeeksId")
                        .HasColumnType("uuid");

                    b.HasKey("PhotoUsersId", "TheBestWeeksId");

                    b.HasIndex("TheBestWeeksId");

                    b.ToTable("PhotoUserTheBestWeek");
                });
            ...
            modelBuilder.Entity("PhotoUserTheBestWeek", b =>
                {
                    b.HasOne("LooksRatingApi.Models.PhotoUser", null)
                        .WithMany()
                        .HasForeignKey("PhotoUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LooksRatingApi.Models.TheBestWeek", null)
                        .WithMany()
                        .HasForeignKey("TheBestWeeksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
